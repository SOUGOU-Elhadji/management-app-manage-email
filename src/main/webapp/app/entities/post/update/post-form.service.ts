...
type PostFormGroupContent = {
  ...
  name_post: FormControl<IPost['name_post']>;
  departement: FormControl<IPost['departement']>;
};
...
export class PostFormService {
  createPostFormGroup(post: PostFormGroupInput = { id: null }): PostFormGroup {
    ...
    return new FormGroup<PostFormGroupContent>({
      ...
      name_post: new FormControl(postRawValue.name_post),
      departement: new FormControl(postRawValue.departement),
    });
  }
