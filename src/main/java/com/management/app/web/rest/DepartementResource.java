...
/**
 * REST controller for managing {@link com.management.app.domain.Departement}.
 */
@RestController
@RequestMapping("/api")
public class DepartementResource {
    ...
    public ResponseEntity<List<DepartementDTO>> getAllDepartements(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
