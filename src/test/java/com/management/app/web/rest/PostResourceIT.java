...
import com.management.app.repository.PostRepository;
import com.management.app.service.PostService;
import com.management.app.service.dto.PostDTO;
import com.management.app.service.mapper.PostMapper;
...
class PostResourceIT {
    ...
    private static final String DEFAULT_NAME_POST = "AAAAAAAAAA";
    private static final String UPDATED_NAME_POST = "BBBBBBBBBB";
    ...
    public static Post createEntity(EntityManager em) {
        Post post = new Post().name_post(DEFAULT_NAME_POST);
        return post;
    }
    ...
    public static Post createUpdatedEntity(EntityManager em) {
        Post post = new Post().name_post(UPDATED_NAME_POST);
        return post;
    }
    ...
    void createPost() throws Exception {
        ...
        assertThat(testPost.getName_post()).isEqualTo(DEFAULT_NAME_POST);
    }
    ...
    void getAllPosts() throws Exception {
        ...
        restPostMockMvc
            ...
            .andExpect(jsonPath("$.[*].name_post").value(hasItem(DEFAULT_NAME_POST)));
    }
    ...
    void getPost() throws Exception {
        ...
        restPostMockMvc
            ...
            .andExpect(jsonPath("$.name_post").value(DEFAULT_NAME_POST));
    }
    ...
    void putExistingPost() throws Exception {
        ...
        updatedPost.name_post(UPDATED_NAME_POST);
        ...
        Post testPost = postList.get(postList.size() - 1);
        assertThat(testPost.getName_post()).isEqualTo(UPDATED_NAME_POST);
    }
    ...
    void fullUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.name_post(UPDATED_NAME_POST);
